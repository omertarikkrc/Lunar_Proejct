...
%% === DESCENT & ASCENT için veri kaydı ===

% Ay merkezli uzay aracı konumu ve hızı
r_current = pos_sat - pos_moon;
v_current = vel_sat_new - vel_moon;

save("r_current.mat", "r_current", "v_current");

fprintf("\n>>> Part 2 için r_current.mat başarıyla kaydedildi.\n");
